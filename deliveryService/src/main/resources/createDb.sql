...
-- -----------------------------------------------------
-- Table `food_delivery`.`custom_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `food_delivery`.`custom_address` (
  `id` INT NOT NULL,
  `custom_address_string` VARCHAR(500) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `idcustom_address_UNIQUE` (`id` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `food_delivery`.`delivery_address` (
  `id` BIGINT(100) NOT NULL,
  `custom_address_id` INT NOT NULL,
  `user_address_id` INT NOT NULL,
  PRIMARY KEY (`id`, `custom_address_id`, `user_address_id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_delivery_address_custom_address1_idx` (`custom_address_id` ASC) VISIBLE,
  INDEX `fk_delivery_address_user_address1_idx` (`user_address_id` ASC) VISIBLE,
  CONSTRAINT `fk_delivery_address_custom_address1`
    FOREIGN KEY (`custom_address_id`)
    REFERENCES `food_delivery`.`custom_address` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `food_delivery`.`order_menu_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `food_delivery`.`order_menu_item` (
  `id` INT NOT NULL,
